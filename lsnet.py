...
# )
default_cfgs = dict(
    lsnet_t = _cfg(url='file:./pretrain/lsnet_t.pth'),
    lsnet_t_distill = _cfg(url='file:./pretrain/lsnet_t_distill.pth'),
    lsnet_s = _cfg(url='file:./pretrain/lsnet_s.pth'),
    lsnet_s_distill = _cfg(url='file:./pretrain/lsnet_s_distill.pth'),
    lsnet_b = _cfg(url='file:./pretrain/lsnet_b.pth'),
    lsnet_b_distill = _cfg(url='file:./pretrain/lsnet_b_distill.pth'),
)
